...
projector evaluation is the known reliable path. For the 6 GB iPhone 14 Pro Max
profile, the context is reduced to 1,024 tokens and uses a 512 logical batch, a
256 physical micro-batch, six CPU threads, Q8 KV caches, and a 192-token image
ceiling. The grounded prompt and spoken output are also bounded. This keeps the
official Q4/Q8 model pair and its accuracy-oriented sampling while reducing
visual prefill and generation work.
